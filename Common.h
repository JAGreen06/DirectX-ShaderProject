...
struct PerFrameConstants
{
    ...
    CVector3   light3Position; // 3 floats: x, y z
    float      padding5;       // Pad above variable to float4 (HLSL requirement - which we must duplicate in this the C++ version of the structure)
